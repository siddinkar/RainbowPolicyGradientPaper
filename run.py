...
from PPO.ppo import ppo as ppo_pytorch
from SAC.SAC import sac as sac_pytorch
from TD3.TD3 import td3 as td3_pytorch
...
def parse_and_execute_grid_search(cmd, args):
    ...
    if any([arg in valid_help for arg in args]):
        print('\n\nShowing docstring for algos.'+cmd+':\n')
        print(algo.__doc__)
        sys.exit()
...
if __name__ == '__main__':
    ...
    assert cmd in valid_cmds, \
        "Select an algorithm or utility which is implemented."
