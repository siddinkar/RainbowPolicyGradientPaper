...
import gym
import time
import Modified_TD3.core as core
...
def modified_td3(env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0,
    ...
    # target networks only update via polyak avging (no autograd thru optimizers like ac)
...
if __name__ == '__main__':
    ...
    modified_td3(lambda: gym.make(args.env), actor_critic=core.MLPActorCritic,
